...
namespace Model
{
  ...
  public:
    ...
    inline void SetLocationConstraintSpecial(const char *value) { m_locationConstraintSpecial = true; m_bucketplacement.assign(value); }
    /**
     * Specifies the region where the bucket will be created. If you don't specify a
     * region, the bucket will be created in US Standard.
     */
  ...
  private:
	...
	bool m_locationConstraintSpecial;
	Aws::String m_bucketplacement;
  };
